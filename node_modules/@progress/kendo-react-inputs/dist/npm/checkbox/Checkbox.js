...
exports.Checkbox = React.forwardRef(function (props, target) {
    var ariaDescribedBy = props.ariaDescribedBy, ariaLabelledBy = props.ariaLabelledBy, checked = props.checked, className = props.className, children = props.children, defaultChecked = props.defaultChecked, disabled = props.disabled, defaultValue = props.defaultValue, id = props.id, label = props.label, labelPlacement = props.labelPlacement, name = props.name, labelOptional = props.labelOptional, onChange = props.onChange, onFocus = props.onFocus, tabIndex = props.tabIndex, value = props.value, required = props.required, valid = props.valid, validationMessage = props.validationMessage, validityStyles = props.validityStyles, others = __rest(props, ["ariaDescribedBy", "ariaLabelledBy", "checked", "className", "children", "defaultChecked", "disabled", "defaultValue", "id", "label", "labelPlacement", "name", "labelOptional", "onChange", "onFocus", "tabIndex", "value", "required", "valid", "validationMessage", "validityStyles"]);
    ...
    var optionalMessage = localizeMessage(messages_1.checkboxOptionalText);
    ...
    var onKeyDownHandler = React.useCallback(function (e) {
        ...
        if (keyCode === kendo_react_common_1.Keys.space) {
            e.preventDefault();
            e.stopPropagation();
